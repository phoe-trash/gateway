...
(defun %crown-constructor-new (crown n-host n-port i-host i-port)
  (destructuring-bind (n-getter e-getter i-getter
    ...
    (setf  (library crown) (make-instance 'standard-library :type :crown)
           ...
           (n-listener crown) (%make-listener n-getter n-pusher sexp-pusher n-cleaner)
           (e-listener crown) (%make-listener e-getter e-pusher sexp-pusher e-cleaner)
           (i-listener crown) (%make-listener i-getter i-pusher sexp-pusher i-cleaner)
...
(defun %crown-constructor-lambdas (crown)
  (list
   ...
   (%crown-cleaner n-lock n-connections)
   (%crown-cleaner e-lock e-connections)
   (%crown-cleaner i-lock i-connections)
